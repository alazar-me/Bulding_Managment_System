...
const Registration = () => {
  ...
  const [tenancyTypeLength, setTenancyTypeLength] = useState("");
  ...
  const [vehiclesDescription, setVehiclesDescription] = useState("");
          ...
          <div className="flex flex-row">
            ...
            <div className="">
              <input
                ...
                required
                className="outline-none border-b bg-white_blue border-black"
                value={tenancyTypeLength}
                onChange={(e) => setTenancyTypeLength(e.target.value)}
              />
            </div>
            <h2>Start Date:</h2>
            <div className="">
          ...
          <div className="flex flex-row pt-3">
            ...
            <div className="">
              <input
                ...
                required
                className="outline-none border-b bg-white_blue border-black"
                value={vehiclesDescription}
                onChange={(e) => setVehiclesDescription(e.target.value)}
              />
            </div>
          </div>
